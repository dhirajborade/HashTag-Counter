...
import com.Heap.NodeFibHeap;

/**
 * Reads hashtags from an input file and outputs the top 'N' hashtags when it
 * encounters a request for top hashtags
 * 
 * @author Dhiraj
 */
public class HashTagCounter {
	 ...
	 * 
	 * @param hashtag
	 *            new tag to insert into heap
	 * @param data
	 *            initial count of the hashtag
	 */
	 ...
	 * 
	 * @param hashtag
	 *            hashtag whose value needs to be increased
	 * @param increase
	 *            increase value
	 */
	 ...
	 * 
	 * @param list
	 *            takes list which contains lines from an input file
	 * @param printw
	 *            PrintWriter object to write output to file
	 */
